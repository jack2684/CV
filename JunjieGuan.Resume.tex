...
\item{Sep 2013 -- Present}
     ...
     \quad1) Implementing games, realizing the media interface for flickr;
     
     \quad2) Helping database design, security enhancement， fix any bugs listed in bug tracker;
